...
is_eye_size_large = eye_size > 0.45
is_eye_shape_roundish = (math.pi*iris_width/2*iris_height/2) / eye_size >= 0.69
is_eye_dimentonal = eye_height/eye_width >= 0.59

if is_eye_size_large and is_eye_shape_roundish and is_eye_dimentonal:
