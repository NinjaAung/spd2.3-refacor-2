...
# Extract Class
class Food():
    def __init__(self, name, prep_time, vegitarian, food_type, cuisine, ingredients, preparation):
        self.name = name
...
butternut_squash_soup = Food('butternut squash soup', 45, True, 'soup', 'North African',
                             ['butter squash', 'onion', 'carrot', 'garlic',
...
shirazi_salad = Food('shirazi salad', 5, True, 'salad', 'Iranian',
...
beef_sausage = Food('Home-made Beef Sausage', 60, False, 'deli', 'All',
